...
class Vegetables(Plant):
    ...
    def get_info(self):
        print(f"{self.name} (Vegetable): {self.height}cm, {self.days} days, "
...
class Flower(Plant):
    ...
    def get_info(self):
        print(f"{self.name} (Flower):{self.height}cm, {self.days} days, "
              f"{self.color} color")
...
class Tree(Plant):
    ...
    def get_info(self):
        print(f"{self.name} (Tree): {self.height}cm, {self.days} days, "
